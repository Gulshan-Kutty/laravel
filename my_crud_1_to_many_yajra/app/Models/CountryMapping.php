...
class CountryMapping extends Model
{
    use HasFactory;
    protected $table="product_countries_mapping";
    ...
    {
        return $this->hasOne('App\Models\Country','id','country_id'); // for one to many relation
    }
}
