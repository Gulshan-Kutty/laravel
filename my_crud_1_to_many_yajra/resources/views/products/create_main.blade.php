        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card mt-3 p-3">
                    <form id='form' action="{{route('products.store')}}" method="post" enctype="multipart/form-data" onsubmit="return validate_form()">
                    {{-- <form id='form' action="{{route('products.store')}}" method="post" enctype="multipart/form-data" onsubmit="validate_form()"> --}}
                        {{-- If you do not prefer to use the 'return' keyword in the onsubmit attribute, you can achieve the same functionality by explicitly preventing the form submission within the JavaScript function itself using event.preventDefault(). --}}
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="email" name="email" type="text" placeholder="Enter Email" value="{{ old('email')}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class='form-control' id="description" name="description" placeholder="Product Description" cols="30" rows="10">{{ old('description')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="from_date" name="from_date" type="text" placeholder="Select Date" value="{{ old('from_date')}}" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="to_date" name="to_date" type="text" placeholder="Select Date" value="{{ old('to_date')}}" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input gender" type="radio" name="gender" id="male" value="male" {{ old('gender') === 'male' ? 'checked' : '' }} >
                                <label class="form-check-label" for="male">Male</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input gender" type="radio" name="gender" id="female" value="female" {{ old('gender') === 'female' ? 'checked' : '' }}>
                                <label class="form-check-label" for="female">Female</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input gender" type="radio" name="gender" id="other" value="other" {{ old('gender') === 'other' ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input status" type="radio" name="status" id="active" checked='checked' value="active" {{ old('status') === 'active' ? 'checked' : '' }} >
                                <label class="form-check-label" for="active">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input status" type="radio" name="status" id="inactive" value="inactive" {{ old('status') === 'inactive' ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-danger" id="hobbyError"></span>
                            @if($errors->has('hobby'))
                        ...
                        <button id='subbtn' type="submit" name="button" class="btn btn-primary">Create</button>
                        {{-- <button id='subbtn' type="button" name="button" class="btn btn-primary">Create</button> --}}
